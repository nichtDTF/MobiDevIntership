...
namespace ThirdApp
{
    class Program
    {
        ...
        /// Creating towns
        /// </summary>
        public static Town Lubeck = new Town();
        public static Town Reval = new Town();
        public static Town Bergen = new Town();
        ...
        static void SetData()
        {
            for (int i = 0; i < 5; i++)
            {
                Lubeck.res[i] = new Resource();
                Reval.res[i] = new Resource();
                Bergen.res[i] = new Resource();
            }
    ...
    {
        /// <summary>
        /// All town`s resources
        /// </summary>
        public Resource[] res = new Resource[5];
    }
    ...
    class Traveler
    {
        ...
        {
            if (HandIsEmpty && Money - resource.cost > 0)
            {
                HandIsEmpty = false;
                Money -= resource.cost;
                ...
                Console.WriteLine("Not enough money or hand is full, you can`t buy this item");
        }
